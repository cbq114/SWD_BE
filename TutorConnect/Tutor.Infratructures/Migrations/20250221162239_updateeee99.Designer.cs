...
namespace Tutor.Infratructures.Migrations
{
    ...
    [Migration("20250221162239_updateeee99")]
    partial class updateeee99
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tutor.Domains.Entities.Users", b =>
                {
                    ...
                    b.Property<int>("FavoriteInstructorsFavoriteInstructorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FavoriteInstructorsFavoriteInstructorId");
            ...
            modelBuilder.Entity("Tutor.Domains.Entities.Users", b =>
                {
                    b.HasOne("Tutor.Domains.Entities.FavoriteInstructors", "FavoriteInstructors")
                        .WithMany()
                        .HasForeignKey("FavoriteInstructorsFavoriteInstructorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
